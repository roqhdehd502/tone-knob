...
export class PracticeProxyController {
  ...
  @Post('sessions')
  @ApiOperation({ summary: '연습 세션 기록', description: '타브 연습 에디터/플레이어에서 한 번의 연습 세션이 끝날 때마다 호출해 기록을 저장합니다. 연습 통계 및 뱃지 적립에 사용됩니다.' })
  ...
  @Get('stats')
  @ApiOperation({ summary: '연습 통계 조회', description: '로그인한 사용자의 총 연습 시간, 연습 횟수 등 누적 통계를 조회합니다.' })
  ...
  @Get('sessions')
  @ApiOperation({ summary: '최근 연습 세션 목록', description: '로그인한 사용자의 연습 세션 기록을 최신순으로 조회합니다.' })
