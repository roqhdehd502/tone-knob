import { Body, Controller, Get, Inject, Param, Put, UseFilters, UseGuards } from "@nestjs/common";
...
export class UserProxyController {
  ...
  @ApiOperation({
    summary: "사용자 프로필 조회",
    description: "다른 사용자의 공개 프로필(닉네임, 표시 이름, 아바타, 자기소개 등)을 조회합니다.",
  })
  ...
  @ApiOperation({
    summary: "사용자 프로필 수정",
    description: "본인 프로필만 수정할 수 있습니다(전달한 필드만 갱신).",
  })
