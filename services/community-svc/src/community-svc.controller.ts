...
export class CommunitySvcController {
  ...
  async createComment(
    @Payload() data: { tabId: string; userId: string; dto: { content: string; parentId?: string } },
  ) {
    return this.communityService.createComment(data.tabId, data.userId, data.dto);
  }
  ...
  async updateComment(
    @Payload() data: { commentId: string; userId: string; dto: { content: string } },
  ) {
  ...
  async toggleFollow(@Payload() data: { followerId: string; followingId: string }) {
    return this.communityService.toggleFollow(data.followerId, data.followingId);
  }
  ...
  async createReview(
    @Payload() data: { tabId: string; userId: string; dto: { rating: number; content?: string } },
  ) {
  ...
  async updateReview(
    @Payload() data: { reviewId: string; userId: string; dto: { rating?: number; content?: string } },
  ) {
