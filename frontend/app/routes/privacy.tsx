  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="prose prose-gray max-w-none dark:prose-invert prose-headings:font-semibold prose-h2:mt-10 prose-h2:text-xl prose-h3:text-lg prose-p:leading-relaxed">
        <p>
          톤 노브(Tone Knob, 이하 "회사")는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한
        ...
        <ol>
          <li><strong>회원가입 및 관리:</strong> 회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지</li>
          <li><strong>서비스 제공:</strong> 타브 제작, 실시간 합주, 커뮤니티, 마켓플레이스 등 서비스 제공, Knob 재화 관리</li>
          <li><strong>고충처리:</strong> 민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락·통지, 처리결과 통보</li>
        </ol>

        <h2>제2조 (수집하는 개인정보의 항목)</h2>
        <ol>
          <li><strong>필수 항목:</strong> 이메일 주소, 사용자 이름(닉네임), 비밀번호(소셜 로그인 제외)</li>
          <li><strong>소셜 로그인 시:</strong> 소셜 서비스 제공자의 고유 식별자, 이메일, 프로필 사진 URL</li>
        ...
        <ol>
          ...
          <li><strong>결제 관련 기록:</strong> 5년 (전자상거래 등에서의 소비자보호에 관한 법률)</li>
        </ol>
        ...
        <ol>
          ...
          <li>권리 행사는 서비스 설정 페이지 또는 이메일(mwna9409@gmail.com)을 통하여 하실 수 있습니다.</li>
        </ol>
        ...
        <ul>
          <li><strong>성명:</strong> 나민우</li>
          <li><strong>직책:</strong> 대표</li>
          <li><strong>이메일:</strong> mwna9409@gmail.com</li>
        </ul>

        <h2>제9조 (개인정보 처리방침 변경)</h2>
        <p>이 개인정보처리방침은 2026년 3월 19일부터 적용됩니다. 변경사항이 있을 경우 서비스 내 공지사항을 통하여 고지할 것입니다.</p>
