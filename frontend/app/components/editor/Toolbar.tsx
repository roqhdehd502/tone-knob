...
import type { Duration, Technique } from "~/types/tab";
...
export function Toolbar({
  ...
  return (
    <div className="space-y-1">
      ...
      {/* 기법 패널 */}
      {showTechniques && (
        <div className="flex flex-wrap gap-1 rounded-lg border border-gray-200 bg-white p-2 dark:border-gray-800 dark:bg-gray-900">
          {TECHNIQUE_META.map((tech) => {
            ...
            return (
              <button
                key={tech.id}
                type="button"
                title={`${tech.label} (${tech.shortcut})`}
              ...
              >
                <span className="font-mono">{tech.symbol}</span>
