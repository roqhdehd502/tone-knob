...
export class CreateTabDto {
  ...
  @ApiPropertyOptional({ description: 'Knob 판매가 (0이면 무료, 마켓플레이스 등록 시 사용)', example: 0, minimum: 0 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  price?: number;
...
export class UpdateTabDto {
  @ApiPropertyOptional({ description: '타브 제목', example: 'Wonderwall (Acoustic)', maxLength: 200 })
  @IsOptional()
  @IsString()
  @MaxLength(200)
  title?: string;
