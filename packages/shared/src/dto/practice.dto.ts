...
export class RecordPracticeSessionDto {
  ...
  @ApiPropertyOptional({ description: '연습 시 사용한 BPM', example: 100, minimum: 1, maximum: 400 })
  @IsOptional()
  @IsInt()
  @Min(1)
  bpm?: number;

  @ApiPropertyOptional({ description: '재생 속도 배율 (예: 0.5 = 절반 속도) — 1배 기준 % 정수로 전달', example: 100, minimum: 10, maximum: 200 })
  @IsOptional()
  @IsInt()
  @Min(10)
  @Max(200)
