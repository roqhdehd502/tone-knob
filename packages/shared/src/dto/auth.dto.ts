...
export class RegisterDto {
  ...
  @ApiProperty({ description: '비밀번호 (8~100자)', example: 'password1234', minLength: 8, maxLength: 100 })
  @IsString()
  @MinLength(8)
  @MaxLength(100)
  password: string;

  @ApiProperty({ description: '화면에 표시될 이름 (선택, 미입력 시 username 사용)', example: '톤놉', required: false, maxLength: 100 })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  displayName?: string;
