...
insert into badges (id, code, name, description, icon, category, "sortOrder")
values
  -- Achievement 카테고리
  ('00000000-0000-0000-0000-b00000000001', 'first_tab',       '첫 타브',          '첫 번째 타브를 제작했습니다',             '🎸', 'achievement', 1),
  ('00000000-0000-0000-0000-b00000000002', 'tab_master_10',   '타브 장인',         '타브를 10개 이상 제작했습니다',           '🏆', 'achievement', 2),
  ('00000000-0000-0000-0000-b00000000003', 'tab_master_50',   '타브 달인',         '타브를 50개 이상 제작했습니다',           '👑', 'achievement', 3),
  ('00000000-0000-0000-0000-b00000000004', 'first_publish',   '첫 공개',          '첫 번째 타브를 공개했습니다',             '📢', 'achievement', 4),
  ('00000000-0000-0000-0000-b00000000005', 'first_fork',      '포크 입문',         '다른 사람의 타브를 처음 포크했습니다',      '🍴', 'achievement', 5),

  -- Contribution 카테고리
  ('00000000-0000-0000-0000-b00000000006', 'first_sale',      '첫 판매',          '마켓플레이스에서 타브를 처음 판매했습니다',   '💰', 'contribution', 10),
  ('00000000-0000-0000-0000-b00000000007', 'popular_tab',     '인기 타브',         '타브가 좋아요 10개를 달성했습니다',        '❤️', 'contribution', 11),
  ('00000000-0000-0000-0000-b00000000008', 'hot_tab',         '핫 타브',          '타브가 좋아요 50개를 달성했습니다',        '🔥', 'contribution', 12),
  ('00000000-0000-0000-0000-b00000000009', 'helpful_reviewer', '리뷰어',           '리뷰를 5개 이상 작성했습니다',            '📝', 'contribution', 13),

  -- Social 카테고리
  ('00000000-0000-0000-0000-b00000000010', 'first_follow',    '첫 팔로우',         '다른 사용자를 처음 팔로우했습니다',        '👋', 'social', 20),
  ('00000000-0000-0000-0000-b00000000011', 'influencer_10',   '인플루언서',        '팔로워 10명을 달성했습니다',             '⭐', 'social', 21),
  ('00000000-0000-0000-0000-b00000000012', 'influencer_50',   '스타',             '팔로워 50명을 달성했습니다',             '🌟', 'social', 22),
  ('00000000-0000-0000-0000-b00000000013', 'first_comment',   '첫 댓글',          '첫 번째 댓글을 작성했습니다',             '💬', 'social', 23),

  -- Special 카테고리
  ('00000000-0000-0000-0000-b00000000014', 'early_adopter',   '얼리 어답터',       '서비스 초기 가입 사용자입니다',           '🚀', 'special', 30),
  ('00000000-0000-0000-0000-b00000000015', 'premium_member',  '프리미엄 멤버',     'Premium 이상 구독을 시작했습니다',        '💎', 'special', 31)
on conflict (id) do nothing;
